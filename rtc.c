...
#define SDA_ON()    (BitSet(PORTB,1))
#define SDA_OFF()   (BitClr(PORTB,1))
#define SDA()       (BitTst(PORTB,1))
#define SDA_IN()    (BitSet(TRISB,1))
#define SDA_OUT()   (BitClr(TRISB,1))



#define SCL_ON()    (BitSet(PORTB,0))
#define SCL_OFF()   (BitClr(PORTB,0))
#define SCL_IN()    (BitSet(TRISB,0))
#define SCL_OUT()   (BitClr(TRISB,0))
...
void rtcSetDateTime(void) {
   ...
   ht1380write(0, 0x00); //sec
   ht1380write(1, 0x01); //min
   ht1380write(2, 0x02); //hora
   ht1380write(3, 0x03); //dia
   ht1380write(4, 0x04); //mes
   ht1380write(5, 0x05); //dia semana
   ht1380write(6, 0x06); //ano
}
