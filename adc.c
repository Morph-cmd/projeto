...
// Obs: No PICGenius o conversor AD está ligado somente no potenciômetro P1
//      O leitor de temperatura está em ADCON2 e não foi implementado
...
#include "pic18f4520.h"
 ...
 void adcInit(void)
{
	BitSet(TRISA,0); //seta o bit 0 como entrada USAR A PORTA CERTA
	
	ADCON0 = 0b00000101; //seleciona o canal 0 e liga o ad                          PROCURAR O VALOR CERTO
